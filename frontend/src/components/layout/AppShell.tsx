...
export default function AppShell({
  ...
  return (
    <div className="flex flex-col min-h-svh bg-background">
      {/* 홈 배경 이미지 — 항상 마운트, opacity로 show/hide → 페이지 전환 시 부드럽게 페이드 */}
      <div
        className="fixed inset-x-0 h-[360px] pointer-events-none transition-opacity duration-500"
        style={{ zIndex: 1, top: 56, opacity: isHome && homeBg ? 1 : 0 }}
      >
        {homeBg && (
          <>
            <img
